...
public class SportsCarBuilder implements CarBuilder {
	...
	public void buildEngine() {
		car.setEngine("3.6L V 6 DOC and variable valve timing");
	}

	@Override
	public void buildBreaks() {
		car.setBreaks(
				"Four-wheel disc brakes: two ventilated. Electronic brake distribution. StabilityTrack stability control");
