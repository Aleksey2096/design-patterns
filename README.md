...
[Python example](python/behavioral/chain_of_responsibility.py)
...
[Python example](python/behavioral/command.py)
...
[Python example](python/behavioral/iterator.py)
...
[Python example](python/behavioral/observer.py)
...
[Python example](python/behavioral/strategy.py)
...
[Python example](python/behavioral/template_method.py)
...
[Python example](python/creational/abstract_factory.py)
...
[Python example](python/creational/builder.py)
...
[Python example](python/creational/prototype.py)
...
[Python example 1](python/structural/adapter_inheritance.py) (via inheritance)

[Python example 2](python/structural/adapter_composition.py) (via composition)
...
[Python example](python/structural/bridge.py)
...
[Python example](python/structural/decorator.py)
